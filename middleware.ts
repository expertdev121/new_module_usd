...
export const config = {
  matcher: [
     ...
     */
    "/((?!api/auth|api/webhook|api/zapier|api/google-daily-sync|api/payroc|api/send-receipt|api/receipts|api/year-end-letters|receipts/|payroc-public|chat|_next/static|_next/image|favicon.ico|auth).*)",
  ],
};
